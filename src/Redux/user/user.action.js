...
export const postSign = (payload) => async (dispatch) => {
    ...
    try {
        let res = await axios.post(
            `https://dull-lime-fly-vest.cyclic.app/auth/signup`,
            payload
        );
...
export const postLogin = (payload) => async (dispatch) => {
    ...
    try {
        let res = await axios.post(
            `https://dull-lime-fly-vest.cyclic.app/auth/login`,
            payload
        );
...
export const getDetailsFromToken = (payload) => async (dispatch) => {
    try {
        let res = await axios.post(
            `https://dull-lime-fly-vest.cyclic.app/auth/verify`,
            payload
        );
...
export const verifyAccessTokenEachPage = () => async (dispatch) => {
    try {
        let res = await axios.get(
            `https://dull-lime-fly-vest.cyclic.app/auth/page`
        );
...
export const settingNewToken = () => async (dispatch) => {
    try {
        let res = await axios.post(
            `https://dull-lime-fly-vest.cyclic.app/auth/refresh`
        );
...
export const LogOut = () => async (dispatch) => {
    try {
        await axios.post(`https://dull-lime-fly-vest.cyclic.app/auth/logout`);
